...
### Cartas Enviadas (`r FECHA_TITULO_FLUJO`) 
...
bind_rows(operadores, pjh) %>% 
  ...
  geom_text(aes(label=scales::number_format(accuracy=1)(numeric), y=y_pos),
            color="white") + 
  scale_fill_manual("", values=c( pal[5], paleta_cats[["rojo"]])) +
...
### Composición de Cartas (`r FECHA_TITULO_FLUJO`)
```{r}
...
### Composición de Paquetes (`r FECHA_TITULO_FLUJO`)
```{r}
## DZ-EB
...
### Cartas Nacionales (`r FECHA_TITULO_FLUJO`)
```{r}
...
### Salida de Cartas Internacionales (`r FECHA_TITULO_FLUJO`)
...
### Entrada de Cartas Internacionales (`r FECHA_TITULO_FLUJO`)
```{r}
...
### Paquetes Nacionales (`r FECHA_TITULO_FLUJO`)
...
### Salida de Paquetes Internacionales (`r FECHA_TITULO_FLUJO`)
...
### Entrada de Paquetes Internacionales (`r FECHA_TITULO_FLUJO`)
```{r}
