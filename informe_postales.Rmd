...
```{r}
importar_columna_trafico(c("AH", "AI", "AJ", "AK"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico(c("AM", "AN", "AO", "AP"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico(c("AR", "AS", "AT", "AU"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico(c("CP", "CQ"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico(c("CS", "CT"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico(c("CV", "CW"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico("BA") %>% 
  group_by(year(fecha), semester(fecha)) %>%
  summarize(numeric=round(sum(numeric))/1e3)
```

```{r}
importar_columna_trafico(c("AW", "AX", "AY", "AZ"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico(c("BL", "BM", "BN", "BO"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico(c("BQ", "BR", "BS", "BT"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico("BZ") %>% 
  group_by(year(fecha), semester(fecha)) %>%
  summarize(numeric=round(sum(numeric))/1e3)
```

```{r}
importar_columna_trafico(c("BV", "BW", "BX", "BY"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
### Total semestral de Paquetes Courier Nacionales (en miles)
```{r}
importar_columna_trafico(c("DQ", "DR"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico(c("DT", "DU"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
...
```{r}
importar_columna_trafico(c("DW", "DX"),
                         header_row=list(cabezal_1=4)) %>% 
  filter(year(fecha)==2020, semester(fecha)==1) %>% 
  group_by(cabezal_1) %>% 
  summarize(numeric=round(sum(numeric)))
